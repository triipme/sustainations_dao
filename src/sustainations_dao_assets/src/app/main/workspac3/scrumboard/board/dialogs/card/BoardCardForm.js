        ...
        <div className="flex flex-auto flex-col py-16 px-0 sm:px-16">
          <div className="flex flex-col sm:flex-row sm:justify-between justify-center items-center mb-24">
            <div className="mb-16 sm:mb-0 flex items-center">
              ...
              <FuseSvgIcon size={20}>chevron_right_outlined</FuseSvgIcon>
          ...
          {cardForm.labels && cardForm.labels.length > 0 && (
            <div className="flex-1 mb-24 mx-8">
              <div className="flex items-center mt-16 mb-12">
                <FuseSvgIcon size={20}>local_offer_outlined</FuseSvgIcon>
          ...
          {cardForm.memberIds && cardForm.memberIds.length > 0 && (
            <div className="flex-1 mb-24 mx-8">
              <div className="flex items-center mt-16 mb-12">
                <FuseSvgIcon size={20}>people_outlined</FuseSvgIcon>
          ...
          {cardForm.attachments && cardForm.attachments.length > 0 && (
            <div className="mb-24">
              <div className="flex items-center mt-16 mb-12">
                <FuseSvgIcon size={20}>attach_file_outlined</FuseSvgIcon>
          ...
          <div className="mb-24">
            <div className="flex items-center mt-16 mb-12">
              <FuseSvgIcon size={20}>textsms_outlined</FuseSvgIcon>
                ...
                {value.length > 0 && (
                  <div className="mb-24">
                    <div className="flex items-center mt-16">
                      <FuseSvgIcon size={20}>assignment_outlined</FuseSvgIcon>
              ...
              <Controller
                ...
                render={({ field: { onChange, value } }) => (
                  <IconButton size="large">
                    <FuseSvgIcon>attach_file_outlined</FuseSvgIcon>
                  </IconButton>
                )}
              />
