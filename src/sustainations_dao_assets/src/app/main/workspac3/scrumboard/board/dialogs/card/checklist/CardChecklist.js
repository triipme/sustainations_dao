    ...
    <div className="mb-24">
      <div className="flex items-center justify-between mt-16 mb-12">
        <div className="flex items-center">
          <FuseSvgIcon size={20}>check_circle_outlined</FuseSvgIcon>
          <Controller
            name="name"
            control={control}
            defaultValue=""
        ...
        <div className="">
          <IconButton
            ...
            size="small"
          >
            <FuseSvgIcon size={20}>more_vert_outlined</FuseSvgIcon>
          </IconButton>
          <Menu
            id="actions-menu"
            anchorEl={anchorEl}
          ...
          >
            <MenuItem onClick={props.onRemoveCheckList}>
              <ListItemIcon className="min-w-40">
                <FuseSvgIcon>delete_outlined</FuseSvgIcon>
              </ListItemIcon>
              <ListItemText primary="Remove Checklist" />
            </MenuItem>
            <MenuItem onClick={handleOpenNameForm}>
              <ListItemIcon className="min-w-40">
                <FuseSvgIcon>edit_outlined</FuseSvgIcon>
              </ListItemIcon>
