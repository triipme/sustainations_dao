...
export default class catalonia_scene12 extends BaseScene {
  constructor() {
    super('catalonia_scene12');
  }
  ...
  preload() {
    ...
    this.characterBefore = this.useUsableItemScene(this.isUsedUsableItem, "e21");
  ...
  update() {
    ...
    if (this.player.x > 3800) {
      ...
      this.scene.start("catalonia_scene13", { isUsedPotion: this.isUsedPotion, isUsedUsableItem: this.isUsedUsableItem });
    }
