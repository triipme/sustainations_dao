...
export default class catalonia_scene10 extends BaseScene {
  constructor() {
    super('catalonia_scene10');
  }
  ...
  preload() {
    ...
    this.characterBefore = this.useUsableItemScene(this.isUsedUsableItem, "e19");
  ...
  update() {
    ...
    if (this.player.x > 3800) {
      ...
      this.scene.start("catalonia_scene11", { isUsedPotion: this.isUsedPotion, isUsedUsableItem: this.isUsedUsableItem });
    }

    if (this.player.x > 2980 && this.isInteracted == false) {
