...
const bg1 = 'metaverse/scenes/catalonia/Scene5/part2/back.png';
const bg2 = 'metaverse/scenes/catalonia/Scene5/part2/mid.png';
const bg3 = 'metaverse/scenes/catalonia/Scene5/part2/front.png';
const selectAction = 'metaverse/scenes/background_menu.png';
const btnBlank = 'metaverse/scenes/selection.png';

export default class catalonia_scene5_2 extends BaseScene {
  constructor() {
    super('catalonia_scene5_2');
  }
  ...
  async create() {
    ...
    this.myCam.setBounds(0, 0, 4574, gameConfig.scale.height); //furthest distance the cam is allowed to move
  ...
  update() {
    ...
    if (this.player.x > 3400 && this.isInteracted == false) {
      this.triggerPause();
      this.ambientSound.stop();
      this.sfx_char_footstep.stop();
