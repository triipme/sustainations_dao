...
const bg1 = 'metaverse/scenes/catalonia/Scene9/PNG/back.png';
const bg2 = 'metaverse/scenes/catalonia/Scene9/PNG/mid.png';
const bg3 = 'metaverse/scenes/catalonia/Scene9/PNG/front.png';
const obstacle = 'metaverse/scenes/catalonia/Scene9/PNG/obstacle.png';
...
export default class catalonia_scene9 extends BaseScene {
  constructor() {
    super('catalonia_scene9');
  }
  ...
  preload() {
    ...
    this.characterBefore = this.useUsableItemScene(this.isUsedUsableItem, "e18");
  ...
  update() {
    ...
    if (this.player.x > 3800) {
      ...
      this.scene.start("catalonia_scene10", { isUsedPotion: this.isUsedPotion, isUsedUsableItem: this.isUsedUsableItem });
    }

    if (this.player.x > 2660 && this.isInteracted == false) {
