...
class menuScene extends Phaser.Scene {
  ...
  create() {
    ...
    //btn
    this.introduction_btn = this.add.sprite(960, 350, "introduction_btn").setInteractive();
    ...
    this.quest_btn = this.add.sprite(960, 470, "quest_btn").setInteractive();
    ...
    this.bootcamp_btn = this.add.sprite(960, 590, "bootcamp_btn").setInteractive();
