...
const heroHoldSteady = 'metaverse/hero/idle.png';
const ground = 'metaverse/transparent-ground.png';
const bg1 = 'metaverse/layer1-scene1.png';
const bg2 = 'metaverse/layer2-scene1-shortened.png';
const bg3 = 'metaverse/layer3-scene1.png';
...
export default class JungleScene extends Phaser.Scene {
  ...
  preload() {
    ...
    this.load.image("hero-idle", heroHoldSteady);
  ...
  create() {
    ...
    this.bg_1 = this.add.tileSprite(
      0, 0, gameConfig.scale.width, gameConfig.scale.height, "background1"
    );
    this.bg_1.setOrigin(0, 0);
    this.bg_1.setScrollFactor(0);
    
    this.bg_2 = this.add.tileSprite(
      0, 0, gameConfig.scale.width, gameConfig.scale.height, "background2"
    );
    ...
    this.bg_3 = this.add.tileSprite(
      0, 0, gameConfig.scale.width, gameConfig.scale.height, "background3"
    );
    ...
    this.myCam.setBounds(
      0, 0, gameConfig.scale.width*4, gameConfig.scale.height
    ); //furthest distance the cam is allowed to move
    ...
    this.option1 = this.add.image(
      gameConfig.scale.width/2, gameConfig.scale.height/2 -100, 'btnBlank'
    ).setScale(1.3);
