...
const bg1 = 'metaverse/scenes/lava/Scene4/PNG/back.png';
const bg2 = 'metaverse/scenes/lava/Scene4/PNG/mid.png';
const bg3 = 'metaverse/scenes/lava/Scene4/PNG/front.png';
const obstacle = 'metaverse/scenes/lava/Scene4/PNG/obstacle.png';
...
export default class lava_scene4 extends BaseScene {
  constructor() {
    super('lava_scene4');
  }
  ...
  async create() {
    ...
    this.des = this.make.text({
      ...
      text: "A big volcanic cave is in front of us, what should we do?",
      origin: { x: 0.5, y: 0.5 },
      style: {
    ...
    for (const idx in this.eventOptions) {
      ...
      this.options[idx].on('pointerdown', () => {
        if (takeable) {
          ...
          if(this.eventOptions[idx][1].description === 'Go back'){
  ...
  update() {
    ...
    if (this.player.x > 5100) {
      ...
      this.scene.start("lava_scene5", { isUsedPotion: this.isUsedPotion, isUsedUsableItem: this.isUsedUsableItem });
    }

    if (this.player.x > 4550 && this.isInteracted == false) {
