...
const item_hp = 'metaverse/farm/Sustaination_farm/farm-object/PNG/craftingItem/HP_Potion.png'
const item_stamina = 'metaverse/farm/Sustaination_farm/farm-object/PNG/craftingItem/Stamina_Potion.png'
const item_mana = 'metaverse/farm/Sustaination_farm/farm-object/PNG/craftingItem/Mana_Potion.png'
const item_morale = 'metaverse/farm/Sustaination_farm/farm-object/PNG/craftingItem/Morale_Potion.png'
const item_super = 'metaverse/farm/Sustaination_farm/farm-object/PNG/craftingItem/Super_Potion.png'
...
export default class lava_scene1 extends BaseScene {
  ...
  update() {
    ...
    if (this.player.x > 5100) {
      ...
      this.scene.start("lava_scene2", {isUsedUsableItem: this.isUsedUsableItem });
    }
