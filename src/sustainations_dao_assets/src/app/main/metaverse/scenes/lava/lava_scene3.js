...
const bg1 = 'metaverse/scenes/lava/Scene3/PNG/back.png';
const bg2 = 'metaverse/scenes/lava/Scene2/PNG/mid.png';
const bg3 = 'metaverse/scenes/lava/Scene2/PNG/front.png';
const obstacle = 'metaverse/scenes/lava/Scene3/PNG/obstacle.png';
...
export default class lava_scene3 extends BaseScene {
  constructor() {
    super('lava_scene3');
  }
