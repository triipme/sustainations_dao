...
const bg1 = 'metaverse/scenes/lake/Scene5/PNG/back.png';
const bg2 = 'metaverse/scenes/lake/Scene5/PNG/mid.png';
const bg3 = 'metaverse/scenes/lake/Scene5/PNG/front.png';
const obstacle = 'metaverse/scenes/lake/Scene5/PNG/obstacle.png';
...
export default class lake_scene5 extends BaseScene {
  constructor() {
    super('lake_scene5');
  }
  ...
  preload() {
    ...
    this.characterBefore = this.useUsableItemScene(this.isUsedUsableItem, "e40");
