...
const bg1 = 'metaverse/scenes/lake/Scene2/PNG/back.png';
const bg2 = 'metaverse/scenes/lake/Scene2/PNG/mid.png';
const bg3 = 'metaverse/scenes/lake/Scene2/PNG/front.png';
const obstacle = 'metaverse/scenes/lake/Scene2/PNG/obstacle.png';
...
export default class lake_scene2 extends BaseScene {
  constructor() {
    super('lake_scene2');
  }
  ...
  preload() {
    ...
    this.characterBefore = this.useUsableItemScene(this.isUsedUsableItem, "e37");
  ...
  update() {
    ...
    if (this.player.x > 5100) {
      ...
      this.scene.start("lake_scene3", {isUsedUsableItem: this.isUsedUsableItem });
    }
