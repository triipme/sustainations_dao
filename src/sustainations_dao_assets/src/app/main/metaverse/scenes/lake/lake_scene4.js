...
const bg1 = 'metaverse/scenes/lake/Scene4/PNG/back.png';
const bg2 = 'metaverse/scenes/lake/Scene4/PNG/mid.png';
const bg3 = 'metaverse/scenes/lake/Scene4/PNG/front.png';
const obstacle = 'metaverse/scenes/lake/Scene4/PNG/obstacle.png';
...
export default class lake_scene4 extends BaseScene {
  ...
  update() {
    ...
    if (this.player.x > 5100) {
      ...
      this.scene.start("lake_scene5", { isUsedPotion: this.isUsedPotion });
    }
