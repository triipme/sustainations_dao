...
export default class Scene1 extends Phaser.Scene {
  ...
  create() {
    ...
    this.option1.text = this.add.text(gameConfig.scale.width/2, gameConfig.scale.height/2 -100, "Cut the bush down to open the way", { fill: '#000000', align: 'center', fontSize: '30px' })
    ...
    this.option2.text = this.add.text(gameConfig.scale.width/2, gameConfig.scale.height/2, "Find a way out without chopping the bush down", { fill: '#000000', align: 'center', fontSize: '30px' })
      .setScrollFactor(0).setVisible(false).setOrigin(0.5);
