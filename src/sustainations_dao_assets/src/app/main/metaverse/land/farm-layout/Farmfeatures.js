...
import { init, drawRect, drawImageOnCanvas, sOft, checkTilePosition, drawRhombus, getCenterCoordinate, canvasConfig, drawImageOnCanvasTest } from "./publicfuntion"
...
function Farm(props) {
  ...
  useEffect(() => {
    ...
    map.map(tile => {
      drawImageOnCanvas(ctx, "metaverse/farm25D/Ground.png", tile.x, tile.y, tile.w, tile.h); // load tile image
    })
